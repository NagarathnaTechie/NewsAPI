...
function Sports() {
  ...
  return (
    <Container className="sports">
      <h1 className="sports-title">Current Sports Events</h1>
        ...
        {articles.length > 0 ? articles.map((article, i) => (
          <Card key={i} className="news-card">
            <div className="news-image-container">
              <Card.Img
                variant="top"
                src={article.urlToImage || '/Images/Sports.jpeg'}
                className="news-image"
                onError={(e) => { e.target.onerror = null; e.target.src = '/Images/Sports.jpeg'; }}
              />
            </div>
