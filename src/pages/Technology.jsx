...
function Technology() {
  ...
  return (
    <Container className="technology">
      <h1 className="technology-title">Tech Innovations</h1>
        ...
        {articles.length > 0 ? articles.map((article, i) => (
          <Card key={i} className="news-card">
            <div className="news-image-container">
              <Card.Img
                variant="top"
                src={article.urlToImage || '/Images/Technology.jpeg'}
                className="news-image"
                onError={(e) => { e.target.onerror = null; e.target.src = '/Images/Technology.jpeg'; }}
              />
            </div>
