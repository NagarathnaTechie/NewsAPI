...
function Business() {
  ...
  return (
    <Container className="business">
      <h1 className="business-title">Latest Business Insights</h1>
        ...
        {articles.length > 0 ? articles.map((article, i) => (
          <Card key={i} className="news-card">
            <div className="news-image-container">
              <Card.Img
                variant="top"
                src={article.urlToImage || 'Images/Business.jpg'}
                className="news-image"
                onError={(e) => { e.target.onerror = null; e.target.src = 'Images/Business.jpg'; }}
              />
            </div>
