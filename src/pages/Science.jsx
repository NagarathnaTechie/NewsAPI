...
function Science() {
  ...
  return (
    <Container className="science">
      <h1 className="science-title">Scientific Discoveries</h1>
        ...
        {articles.length > 0 ? articles.map((article, i) => (
          <Card key={i} className="news-card">
            <div className="news-image-container">
              <Card.Img
                variant="top"
                src={article.urlToImage || '/Images/Science.jpeg'}
                className="news-image"
                onError={(e) => { e.target.onerror = null; e.target.src = '/Images/Science.jpeg'; }}
              />
            </div>
